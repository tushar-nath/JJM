...
dropdown.value = sessionStorage.getItem('timeinterval1');
dropdown2.value = sessionStorage.getItem('timeinterval2');
dropdown3.value = sessionStorage.getItem('timeinterval3');
